    ...
    <div className="bg-gray-50 border rounded-lg shadow-sm p-4 animate-fade-in">
        ...
        <div className="mt-4 pt-4 border-t border-gray-200 flex space-x-3">
             <button
                ...
                className="flex-1 inline-flex justify-center items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-orange-500 hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition-colors"
            >
