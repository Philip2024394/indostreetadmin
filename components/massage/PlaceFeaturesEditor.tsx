                    ...
                    <div className="mt-2 grid grid-cols-1 sm:grid-cols-3 gap-4">
                        {galleryImages.map((photo) => (
                         ...
                         {galleryImages.length < 3 && (
                            <label htmlFor="gallery-upload" className="cursor-pointer flex items-center justify-center w-full min-h-[148px] bg-gray-50 border-2 border-dashed border-gray-300 rounded-md hover:border-orange-500">
