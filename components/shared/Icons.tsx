...
export const UserGroupIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.653-.284-1.255-.778-1.682M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.653.284-1.255.778-1.682m0 0A12.001 12.001 0 0112 13c2.25 0 4.34.867 5.968 2.288M12 13a4 4 0 100-8 4 4 0 000 8zm0 0v4m0 0H8m4 0h4" />
    </svg>
);
...
export const IdCardIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 012-2h4a2 2 0 012 2v1m-4 0h4m-9 4h2m-2 4h2m-2 4h2m6-12v12" />
    </svg>
);
...
export const ShieldCheckIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 20.944L12 22l9-1.056v-5.556a12.02 12.02 0 00-2.382-7.484z" />
    </svg>
);

export const MotorcycleIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 16a4 4 0 100-8 4 4 0 000 8zm0 0v1m0-9V4m0 1.5s-1.5 2-4.5 2-4.5-2-4.5-2" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 10.5c0 2.5 1.5 4.5 4.5 4.5s4.5-2 4.5-4.5" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 10.5S6 13 3 13m13.5 0c3 0 4.5-2.5 4.5-2.5" />
    </svg>
);
...
// Fix: Add missing ChevronDownIcon component to resolve import error in MemberManagementPage.
...
// Fix: Updated CheckIcon to accept a 'title' prop for accessibility and to fix a type error.
...
export const LandmarkIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21V3m0 18H3m9 0h9m-9-6.375L6.25 9.375M12 14.625L17.75 9.375" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 21h18M5.25 9.375h13.5" />
    </svg>
);
...
export const iconMap: { [key: string]: React.FC<{ className?: string }> } = {
    LogoutIcon, ShieldCheckIcon, CarIcon, StoreIcon, UserGroupIcon, DocumentTextIcon, DollarSignIcon, ChartBarIcon, BellIcon, LandmarkIcon, BanknotesIcon, MotorcycleIcon, SparklesIcon, RealCarIcon, DevicePhoneMobileIcon, CalendarIcon, BriefcaseIcon, CheckCircleIcon, IdCardIcon, BookOpenIcon, FoodIcon, MenuIcon, XIcon, UserCircleIcon, InformationCircleIcon, LockClosedIcon, CogIcon, ServerIcon, CubeIcon, KeyIcon, MapPinIcon, PaperAirplaneIcon, PlusCircleIcon, SearchIcon, TrashIcon
};
