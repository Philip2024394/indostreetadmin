...
import { Partner, PaymentMethods, PaymentMethod } from '../../types';
...
const RenewalModal: React.FC<RenewalModalProps> = ({ partner, onClose }) => {
    ...
    const prices = {
        3: content.numbers['membership-price-3mo'] || 150000,
        6: content.numbers['membership-price-6mo'] || 280000,
        12: content.numbers['membership-price-12mo'] || 500000,
    };
    ...
    const PriceCard: React.FC<{ months: 3 | 6 | 12; price: number }> = ({ months, price }) => (
        ...
        >
            ...
            <p className="text-xl font-semibold text-blue-600">
                <Editable editId={`membership-price-${months}mo`} type="number" defaultValue={price} prefix="Rp " />
            </p>
        </div>
    );
